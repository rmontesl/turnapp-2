...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
  ...
  <link rel="stylesheet" href="../../vista/assets/css/app.css">
        <script src="../../programador/js/bootstrap-datetimepicker.js"></script>
        <link rel="stylesheet" href="../../programador/css/bootstrap-datetimepicker.min.css" />
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <select type="" name="" id="email" class="form-control input-sm" required> <!--Supplement an id here instead of using 'text'-->
  <option value="Operarios">Operarios</option> 
  <option value="Distribuidores" selected>Distribuidores</option>
  <option value="Comercializadores">Comercializadores</option>
</select>
        	<label>Comentarios</label>
        	<input type="text" name="" id="telefono" class="form-control input-sm" required row="3">
      </div>
