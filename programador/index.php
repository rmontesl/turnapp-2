                ...
                <div class="row">
                        <div class="page-header"><h2></h2></div>
                                <div class="pull-left form-inline"><br>
                                        ...
                                        <div class="btn-group">
                                            <button class="btn" data-calendar-view="year">Año</button>
                                            <button class="btn active" data-calendar-view="month">Mes</button>
                                            <button class="btn" data-calendar-view="week">Semana</button>
                                            <button class="btn" data-calendar-view="day">Dia</button>
                                        </div>

                                </div>
                                    <div class="pull-right form-inline"><br>
                                        <button class="btn" data-toggle='modal' data-target='#add_evento'>Añadir Evento</button>
                                    </div>
      ...
      <div class="modal-body">
        <form action="" method="post">
                    ...
                    <select class="form-control" name="class" id="tipo" required="">
                        <option value="event-info">Turno</option>
                        <option value="event-success">Turno Extra</option>
                        <option value="event-important">Capacitación</option>
                    </select>

                    <br>


                    <label for="title">Cadena hibrida de valor</label>
                    <input type="text" required autocomplete="on" name="title" class="form-control" id="title" placeholder="Introduce una CHV" required="">

                    <br>


                    <label for="body">Miembros</label>
                    <textarea id="body" name="event" required autocomplete="on" class="form-control" rows="3"></textarea>
